...
sandbox. The app, store and tests were run natively; `Dockerfile` are reviewed
but not exercised.

Tests (557, all passing) cover the cursor, traversal rejection, record forgery, the POST lane,
